...
const DoorOpen = createLucideIcon("door-open", __iconNode$c);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const services = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(House, { className: "w-7 h-7" }),
    title: "Wall & Ceiling Inspection",
    description: "We meticulously examine all walls and ceilings for cracks, dampness, seepage, and water leakage — including hidden moisture that could lead to structural damage."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(DoorOpen, { className: "w-7 h-7" }),
    title: "Door & Window Inspection",
    description: "Every door and window is checked for cracks, physical damage, improper alignment, and faulty seals that could compromise security or energy efficiency."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "w-7 h-7" }),
    title: "Flooring Inspection",
    description: "Our experts tap and assess every floor tile to identify loose, hollow, or cracked tiles — catching issues before they become expensive repairs."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-7 h-7" }),
    title: "Electrical Checks",
    description: "All switchboards, plug sockets, and wiring are thoroughly tested for safety compliance, proper earthing, and signs of overloading or faulty connections."
  }
];
const checkpoints = [
  {
  ...
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardList, { className: "w-5 h-5 text-accent" }),
    text: "Detailed written inspection report delivered"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-5 h-5 text-accent" }),
    text: "Photo documentation of every issue found"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-5 h-5 text-accent" }),
    text: "Room-by-room structured assessment"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-5 h-5 text-accent" }),
    text: "Certified inspector with local expertise"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-5 h-5 text-accent" }),
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background font-body", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-white shadow-nav" : "bg-white/95 backdrop-blur-md"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 h-16 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full amber-gradient flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-4 h-4 text-white" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-primary text-lg leading-tight", children: [
                "Pune Expert",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs font-body font-medium text-muted-foreground tracking-widest uppercase", children: "Home Inspections" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-1", children: [
              navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `px-4 py-2 text-sm font-medium rounded-md transition-colors ${activeSection === link.id ? "text-accent bg-accent/10" : "text-foreground/70 hover:text-primary hover:bg-secondary"}`,
                  children: link.label
                },
                link.id
              )),
          ...
          menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-white border-t border-border shadow-lg", children: [
            navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-[92vh] flex items-center pt-16 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "absolute inset-0 bg-cover bg-center bg-no-repeat",
          style: {
            backgroundImage: "url('/assets/generated/hero-inspection.dim_1200x600.jpg')"
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-overlay absolute inset-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative container mx-auto px-4 py-24 max-w-3xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-6 bg-accent/20 text-accent border-accent/30 text-xs font-semibold tracking-wider uppercase", children: "Pune's #1 Home Inspection Service" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6", children: [
          "Pune's Trusted",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-accent", children: "Home Inspection" }),
          "Experts"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/85 text-lg sm:text-xl mb-10 max-w-xl leading-relaxed", children: "Know every corner of your home before you move in. We inspect every surface, wire, and tile — so you can move in with confidence." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 flex flex-wrap gap-6", children: [
          {
            label: "100+ Checkpoints",
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardList, { className: "w-4 h-4" })
          },
          { label: "Photo Reports", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-4 h-4" }) },
          {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: item.icon }),
              item.label
            ]
          },
          item.label
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "py-24 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-primary/10 text-primary border-primary/20 text-xs font-semibold tracking-wider uppercase", children: "What We Check" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground mb-4", children: "Our Inspection Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto", children: "A structured, methodical inspection across four critical areas of your home — nothing is missed." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: services.map((service, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-lg bg-primary/8 text-primary flex items-center justify-center mb-4 group-hover:bg-accent/10 group-hover:text-accent transition-colors", children: service.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg text-foreground mb-3", children: service.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "inspection", className: "py-24 section-alt", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-accent/15 text-accent border-accent/25 text-xs font-semibold tracking-wider uppercase", children: "Deep-Dive Assessment" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground mb-6", children: [
          "Comprehensive",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-primary", children: "Indoor Inspection" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/75 text-base leading-relaxed mb-6", children: "Our inspection process goes far beyond a quick visual walk-through. We move room by room, evaluating every surface, fixture, and fitting with precision. Each property receives a structured assessment that leaves nothing to guesswork." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/75 text-base leading-relaxed mb-8", children: "At the end of your inspection, you receive a comprehensive written report with photographic evidence of every issue identified — giving you the information you need to negotiate, repair, or simply move in with peace of mind." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-4", children: checkpoints.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 mt-0.5", children: item.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground/85 leading-snug", children: item.text })
          ]
        },
        item.text
      )) })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "areas", className: "py-24 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-primary/10 text-primary border-primary/20 text-xs font-semibold tracking-wider uppercase", children: "Service Coverage" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground mb-4", children: "Areas We Serve" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "Wherever you are in Pune, we come to you." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-primary p-8 text-center mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-10 h-10 text-accent mx-auto mb-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-white mb-3", children: "We Cover All of Pune" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-base leading-relaxed", children: "From Hinjewadi to Viman Nagar, Kothrud to Wagholi — and everywhere in between. No matter which neighbourhood your property is in, our inspectors are ready to visit." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 justify-center", children: [
          ...
          "Pune Camp",
          "Deccan"
        ].map((area) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
            variant: "outline",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 section-alt", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-accent/15 text-accent border-accent/25 text-xs font-semibold tracking-wider uppercase", children: "Let's Talk" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground mb-4", children: "Get in Touch" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "Ready to book an inspection or have questions? Reach out to us — we're just a call or message away." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto grid sm:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-green-100 flex items-center justify-center shrink-0 group-hover:bg-green-200 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-6 h-6 text-green-600" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wider mb-1", children: "WhatsApp / Call" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-lg", children: "81493 84610" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-green-600 font-medium mt-0.5", children: "Chat on WhatsApp →" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            className: "flex items-center gap-4 p-6 rounded-xl bg-white border border-border shadow-xs hover:shadow-card hover:-translate-y-0.5 transition-all duration-200 group",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center shrink-0 group-hover:bg-primary/15 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-6 h-6 text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wider mb-1", children: "Phone" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-lg", children: "81493 84610" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary font-medium mt-0.5", children: "Tap to call →" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-accent/15 flex items-center justify-center shrink-0 group-hover:bg-accent/25 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-6 h-6 text-accent" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wider mb-1", children: "Email Us" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: "inspections@puneexperthomeinspections.com" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "We respond within 24 hours" })
              ] })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-muted-foreground text-sm mt-8 max-w-md mx-auto", children: "Available Monday – Saturday, 9 AM to 7 PM. We serve all areas across Pune with prompt scheduling." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-primary text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-3 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full amber-gradient flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-4 h-4 text-white" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg", children: "Pune Expert Home Inspections" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/70 text-sm leading-relaxed", children: "Pune's trusted home inspection service — thorough, professional, and reliable. Know your home inside out before you commit." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-primary-foreground/90 mb-4 text-sm uppercase tracking-wider", children: "Quick Links" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-primary-foreground/90 mb-4 text-sm uppercase tracking-wider", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-4 h-4 text-accent shrink-0" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 text-primary-foreground/70 text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/15 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-primary-foreground/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Pune Expert Home Inspections. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
